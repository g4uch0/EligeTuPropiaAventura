...
public class EjemploTexto {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        libro[0] = new Libro("Ya habías pasado en anteriores ocasiones por el Cañón de la Serpiente, cuando ibas en bicicleta a visitar a tu tío Howard en el rancho Red Creek, pero nunca te habías fijado en la entrada de la cueva. Parece como si un desprendimiento de rocas la hubiese dejado al descubierto recientemente. " +
        ...
        do {
            options = s.nextInt(); // ACORDE AL NUMERO QUE ESCRIBA EL USUARIO SE VAN A DAR LOS SIGUIENTES PASOS
            System.out.println(" ");
            if(options == 1) {
                    valueOpt1 = valueOpt1 + 1 ;
                    System.out.println(libro[valueOpt1] + "\n");
                    if ((libro[valueOpt1].toString().contains("#"))) {
                        Matrix();
                        flag = false;
                    }
                }
                if (options == 2){
                    ...
                    if (valueOpt1 == 45) {
                        ...
                        valueOpt2 = (int) Math.round(valueOpt2 / 2.0);
                    }
                }
        } while (flag);
    }
